...
#  Air Quality Sensor Assembly Guide (ESP32 version)
...
-  **SD card data logging** for long data records  
-  **Mini OLED screen** for real-time data display
-  **WiFi connectivity** integrated to Google Sheets
-  **Semi Portable design** for indoor/outdoor use
